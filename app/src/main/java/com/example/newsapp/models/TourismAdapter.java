...
public class TourismAdapter extends RecyclerView.Adapter<TourismAdapter.MyViewHolder> {
    ...
    public TourismAdapter(Context context, List<Tourism> tourisms){
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, int position) {
        ...
        Tourism tourism = tourisms.get(position);
        ...
        holder.title.setText(tourism.getTitle());
        holder.created.setText(tourism.getCreated());
        holder.body.setText(tourism.getBody());
        holder.uid.setText(tourism.getUid());
        holder.field_category.setText(tourism.getField_category());
    }
